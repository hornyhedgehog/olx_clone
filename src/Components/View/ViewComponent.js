    ...
    return (
        <React.Fragment>
            <div className="viewParentHorizontalDiv">
                {show3dview ? <ComponentA postContent={postContent}/> : <ComponentB postContent={postContent}/>}
                {" "}
                <div className="rightSection">
                    <div className="productDetails">
                        ...
                        <div className="model-buttons-box">
                            <button className="preview-button" onClick={handleButtonClick}><img
                        ...
                        <p>Створено {postContent.createdAt}</p>
                    </div>
                ...
                <div className="descriptionSection">
                    ...
                    {!!userDetails &&
                        <div className="contactDetails">
                            <p className="p-bold">Контакти користувача</p>
                            <p>Ім'я : {userDetails?.name}</p>
                            <p>Номер телефону : {userDetails?.phone}</p>
                        </div>
                    }
                </div>
            </div>
...
function ComponentA({postContent}) {
    return (
...
function ComponentB({postContent}) {
    return (
        <div className="imageShowDiv">
